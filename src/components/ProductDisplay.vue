  ...
  <div>
    ...
    <section class="wrapper">
      <div class="product-box">
        ...
        <UnavailableProduct v-if="!fetchStatus && !isAvailable" :nextFunction="fetchNextProduct" />
          ...
          <div class="wrapper-col">
                ...
                <div class="category">
                  ...
                  <div class="rating">
                    ...
                    <div class="rating-circle">
                      <div v-for="index in 5" :key="index" class="circle"
                        :class="[theme.rating, { [theme.filled]: index <= product?.rating?.rate }]"></div>
                    </div>
                  </div>
                </div>
                <hr />
            ...
            <div class="detail-wrapper">
              ...
              <div class="btns-wrapper">
                ...
                <button :class="theme.buttonNext" @click="fetchNextProduct">Next Product</button>
              </div>
            </div>
          </div>
        </div>
